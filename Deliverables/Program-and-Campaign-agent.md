...
### Next Step for you (Member 4):

If you agree with this logic, you should hand this to **Member 2** so they can write the backend database rules (e.g., blocking any milestone over 50% of the total), and hand it to **Member 3** so they can build the prompt-injection and evaluation tests for the "Negative Tests" defined above.

_(Note: If you meant the **Compliance & Due-Diligence Agent**, which handles Organization Onboarding before campaigns are even created, let me know and I will draft the KYC/Risk matrix business rules for that one instead!)_
